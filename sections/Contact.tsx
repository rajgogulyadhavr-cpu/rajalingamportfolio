                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
                    ...
                    >
                        ...
                        <div className="flex gap-4 pt-6">
                            <a href="https://www.linkedin.com/in/rajalingam-narayanakumar-578a69348?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="p-3 bg-secondary/50 rounded-full hover:bg-primary hover:text-primary-foreground transition-colors cursor-pointer text-muted-foreground hover:scale-110">
                                <Linkedin size={20} />
                            </a>
                            <a href="https://github.com/rajgogulyadhavr-cpu" target="_blank" rel="noopener noreferrer" className="p-3 bg-secondary/50 rounded-full hover:bg-primary hover:text-primary-foreground transition-colors cursor-pointer text-muted-foreground hover:scale-110">
                                <Github size={20} />
                            </a>
                        </div>
                    </motion.div>
